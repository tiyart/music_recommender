...
st.markdown("""
<style>
    /* Reduce vertical spacing around labels and widgets */
    ...
    /* Reduce spacing between radio button group and label */
    div[role="radiogroup"] {
        margin-top: 0.1rem !important;
        margin-bottom: 0.3rem !important;
    }
    /* Optional: reduce space around buttons */
...
st.markdown("<div style='font-size:15px; font-weight:600;'>When it comes to socialising:</div>", unsafe_allow_html=True)
social = st.selectbox(
    "",
    [
...
st.markdown("<div style='font-size:15px; font-weight:600;'>When processing information:</div>", unsafe_allow_html=True)
info = st.selectbox(
    "",
    [
...
st.markdown("<div style='font-size:15px; font-weight:600;'>When making decisions:</div>", unsafe_allow_html=True)
...
st.markdown("<div style='font-size:15px; font-weight:600;'>When planning my day or tasks:</div>", unsafe_allow_html=True)
...
st.markdown("<div style='font-size: 15px; font-weight:600; margin-bottom:0.1rem;'>Preferred music tempo:</div>", unsafe_allow_html=True)
tempo = st.radio(
    "",
